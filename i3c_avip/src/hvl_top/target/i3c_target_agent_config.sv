...
class i3c_target_agent_config extends uvm_object;
  ...
  // Used by monitor proxy + driver proxy to build the
  // config_db key "i3c_target_monitor_bfm_<target_id>"
  // so multiple target agents do not collide.
 ...
 bit  has_daa               = 0;
  ...
  bit [47:0] pid = 48'hAABBCCDDEEFF;  // default Provisional ID
  bit [7:0]  bcr = 8'h00;             // default BCR
  bit [7:0]  dcr = 8'hC2;            // default DCR
